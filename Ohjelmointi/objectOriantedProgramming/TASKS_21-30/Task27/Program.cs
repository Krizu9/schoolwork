...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("Input 4 to export players of chosen team as .csv file. (The chosen team needs to be added first.)");
            ...
            switch (option)
            {
                ...
                case 4:
                    Console.WriteLine("\nWhich team would you like to export? ");
                    string exportTeam = Console.ReadLine();
                    if (string.IsNullOrEmpty(exportTeam))
                    {
                        Console.WriteLine("\nInvalid team name\n");
                        break;
                    }
                    var selectedTeam = teams.Find(t => t.Name.ToLower() == exportTeam.ToLower());
                    ...
                    using (var writer = new System.IO.StreamWriter(selectedTeam.Name.ToLower() + ".csv"))
                    {
                    ...
                    Console.WriteLine("\nPlayers exported to {0}.csv\n", selectedTeam.Name.ToLower());
                    break;
