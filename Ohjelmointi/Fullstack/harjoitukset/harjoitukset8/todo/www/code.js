...
async function loadTodos() {
    let response = await fetch('http://localhost:3060/todos')
...
async function addTodo() {
    ...
    const response = await fetch('http://localhost:3060/todos', {
        method: 'POST',
        headers: {
...
async function removeTodo(id) {
    const response = await fetch('http://localhost:3060/todos/' + id, {
        method: 'DELETE'
    })
